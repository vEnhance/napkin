...
\end{example}
\footnotetext{The reason is actually not very straightforward, but you can see for yourself why it
is true: if there are only finitely many nonzero terms, then the order of the pole at $\infty$,
$(-\ord_\infty(f))$, is precisely the degree of the highest nonzero coefficient.}
