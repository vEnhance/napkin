...
\section{Digression on motivation}
...
\begin{example}
	...
	with the isomorphism $n \pmod 15 \mapsto (n \pmod 3, n \pmod 5)$.
\end{example}
\begin{remark}
...
\end{ques}
\begin{exercise}
	If $k$ is a field, how many ideals does it have?
\end{exercise}
...
are principal is called a \vocab{principal ideal domain},
