...
Well, I guess I'll define a ring\footnote{Or, according to some authors, a ``commutative ring with unit''.
...
of the ring $R$.
A nontrivial ring with no zero divisors is called a \vocab{integral domain}.
...
We call such an ideal which is generated by a single \vocab{principal ideal}.
...
\end{definition}
\begin{definition}
	An non-proper ideal $I$ is a \vocab{prime ideal}
