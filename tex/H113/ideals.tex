...
Not for all rings though: in $\Zc{15}$, $3 \cdot 5 \equiv 0 \pmod{15}$.
...
That is,
\begin{definition}
	A subset $I \subseteq R$ is an \vocab{ideal}
...
\begin{sproblem}
	...
	\begin{enumerate}[(a)]
		...
		\ii Use Zorn's lemma to prove the result if $R$ isn't Noetherian.
	\end{enumerate}
	\begin{hint}
