...
% the roots in fact **do** need to be related to each other? In fact a permutation of the roots only work when the minimal polynomials (over F) of the roots are kept the same
