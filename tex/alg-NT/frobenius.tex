...
\begin{theorem}[The Frobenius element]
	...
	It is called the \vocab{Frobenius element} at $\pp$, and has order $f$.
\end{theorem}
\begin{proof}
	First, observe:
	\begin{ques}
...
a lot like Frobenius element already}.
So we shouldn't be surprised if the Frobenius element of $\Gal(L/\QQ)$
