...
\end{lemma}
This lemma allows us to tell the splitting behavior of $\kp$ just by computing the
$\Frob_\kp$, such as seen in \Cref{lem:cyclo_frob};
or vice versa -- linking whether $p$ splits or is inert
