...
they had in metric spaces when works in general topological spaces.
...
\begin{figure}[ht]
	\centering
	\snsd[height=6cm]{limit-point-neighborhood.jpg}
...
\begin{figure}[ht]
	\centering
	\snsd[height=9cm]{stars-limit-point-infinity.jpg}
