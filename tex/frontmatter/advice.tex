...
In this book, there are there hierarchies:
\begin{itemize}
	...
	\begin{itemize}
		...
		\ii \textbf{Starred problems}, indicating results which will be used later on.\footnote{%
			...
			would invoke some result that was only mentioned on the homework.
			In fact, sometimes very important results were placed on the homework in this way.
...
A equivalence relations partitions $X$ into several \vocab{equivalence classes}.
