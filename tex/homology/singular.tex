...
One na\"ive guess is that this might equal $H_n(X) / H_n(A)$.
...
This will turn out to be true in some nice circumstances,
which we describe when we discuss the Excision Theorem.
For now it may be best to treat $H_n(X,A)$ as a formal object.
