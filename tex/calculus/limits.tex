...
\begin{example}
	...
	which is $\ge$ every element of $S$''.
\end{example}
To write it out:
\begin{definition}
...
\begin{definition}
	...
	The \vocab{limit infimum} is defined similarly,
...
numbers converge to irrational numbers.
...
Therefore, the value of this limit does not depend on $f(p)$ itself.
\begin{example}
