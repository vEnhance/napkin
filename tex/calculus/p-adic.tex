\chapter[Bonus: p-adic numbers]{Bonus: $p$-adic numbers}
...
\textbf{Dependency bug}: for this chapter,
you will need to have read about rings and fields to follow this chapter,
since it's at the intersection of basic algebra and basic analysis.
...
\todo{IMO logo this one as well, like Japan}
\begin{example}
	[USA TST 2002/2]
...
The big important theorem\todo{link completion} I must state now is:
\begin{theorem}
	[$\QQ_p$ is complete]
...
\todo{cite Schikof in refs}
\begin{theorem}
	[Mahler; see Schikhof Theorem 51.1 and Exercise 51.B]
