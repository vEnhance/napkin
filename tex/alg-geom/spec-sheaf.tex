...
\begin{moral}
	The stalks consist of enriched values;
	the residue field has (un-enriched) values.
\end{moral}
...
\begin{definition}
	...
	i.e.\ the residue field of the stalk of $\Spec A$ at $\kp$,
...
\begin{theorem}
	[The germ-to-value commutative diagram]
