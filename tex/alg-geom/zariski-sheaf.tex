...
\begin{definition}
	...
	and polynomials $g_p, h_p \in \CC[V]$ such that
...
Thus, $\phi$ should be ``locally'' a quotient of two polynomials.
...
\begin{theorem}
	...
	\]
	In particular, $\OO_V(V) = \OO_V(D(1)) = \CC[V]$.
\end{theorem}
\begin{proof}
	Omitted.
...
\end{proof}
This means that the global regular functions are just the same as those in the coordinate ring:
