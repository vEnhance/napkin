...
\[ \int_c df = f(b) - f(a). \]
This is the first case of something we call Stoke's Theorem.
...
This is again just a case of the so-called Stoke's Theorem.
...
\todo{define angle form}
\section\problemhead
\todo{maybe include some direct computation}
