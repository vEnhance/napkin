...
The \vocab{adjoint} (soon \vocab{conjugate transpose}) of $T$, denoted $T^\dagger$,
...
\begin{definition}
	...
	For real finite-dimensional inner product spaces
	we say ``self-adjoint'', ``Hermitian'' or \vocab{symmetric}.
\end{definition}
