...
Now, the beauty of Fourier analysis is that it has a great basis:
\begin{theorem}
...
for $\wh f(n)$ with $\sum_n \left\lvert \wh f(n) \right\rvert^2 < \infty$.
...
\[
	...
	\end{array}
\]
I snuck in a fourth row with $Z  = \Zm /n$,
