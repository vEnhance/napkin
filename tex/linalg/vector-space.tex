...
\begin{definition}
	...
	set $\{v_1, \dots, v_n\}$ of vectors in a module $M$.
	\begin{itemize}
...
\begin{theorem}[Maximality and Minimality of Bases]
	If $e_1$, $e_2$, \dots, $e_n$ form a basis of a module $M$, then
	\begin{enumerate}[(a)]
	...
	\end{enumerate}
	If $M$ is a vector space, conditions
	(a) and (b) also imply that the $\{e_i\}$ are a basis.
...
\begin{example}
	...
	\todo{use boldface for standard basis here (and elsewhere)}
\end{example}
