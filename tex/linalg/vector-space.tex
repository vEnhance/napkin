...
\begin{definition}
	...
	set of vectors $v_1, \dots, v_n$ in a module $M$.
	\begin{itemize}
...
\begin{theorem}[Maximality and Minimality of Bases]
	...
	Let $V$ be a vector space and $e_1, \dots, e_n \in V$. The following are equivalent
	\begin{enumerate}[(a)]
	...
	\end{enumerate}
	If we replace $V$ by a general module $M$, then (a) $\implies$ (b) and (a) $\implies$ (c)
	but not conversely.
\end{theorem}
\begin{proof}
