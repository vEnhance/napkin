...
\begin{problem}
	...
	\begin{enumerate}[(a)]
	\ii \gim For any contravariant functor $X : \AA^{\text{op}} \to \catname{Set}$,
	exhibit an isomorphism of $\catname{Set}$, (i.e.\ a bijection)
...
1there is only one thing you can possibly do.
