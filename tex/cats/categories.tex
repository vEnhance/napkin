...
One can also do the dual construction to get a \vocab{coproduct}: given $X$ and $Y$, it's the object $X+Y$
...
\begin{example}
	...
	\begin{enumerate}[(a)]
		...
		Indeed, if a homomorphism $\QQ \to A$ agrees on every integer then it agrees everywhere (why?),
