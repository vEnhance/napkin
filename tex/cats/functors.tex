...
see \Cref{thm:fundgrp_functor}, where we e.g.\ get for free that homotopic
...
These functors have a name: a \vocab{contravariant functor}.  Pictorially:
\begin{diagram}
	& A_1 & & B_1 & = F(A_1) & \\
...
\begin{example}[Contravariant Yoneda Functor]
	The \vocab{contravariant Yoneda functor} $H_A : \AA\op \to \catname{Set}$;
...
\section{Massive Digression: Yoneda Lemma}
...
\end{theorem}
\begin{remark}[Technical Digression]
