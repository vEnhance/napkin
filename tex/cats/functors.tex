...
\begin{example}
	...
	\vocab{covariant Yoneda functor} $H^A : \AA \to \catname{Set}$
...
Now, let me give an explanation of why we might care.
...
For example, I claimed earlier (in \Cref{sec:double_dual})
