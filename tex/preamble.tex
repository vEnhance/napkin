...
%%fakesection Category Theory macros
% (put here instead of macros.tex to avoid Asymptote loading TikZ every compilation which is slow)
...
\begin{asydef}
	...
	usepackage("amsmath");
	usepackage("amssymb");
	texpreamble("\input{tex/macros}"); // must be after loading amsmath
