...
%% Environments, meta-level stuff, etc.
...
\renewcommand*{\partformat}{\color{purple}\scalebox{2.5}{\thepart\autodot}
\enlargethispage{2em}}
...
\renewcommand\beforeparttoc{\hspace{\fill}\rule{0.95\linewidth}{2pt}
\hspace{\fill}}
\let\oldpart\part
