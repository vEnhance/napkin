...
In particular, the winding number is always an integer (Essentially, it uses 
the complex logarithm to track how the arguement changes. The details are more complicated,
