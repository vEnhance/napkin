...
\part{Algebraic Geometry I: Building the Scheme}
\include{tex/alg-geom/affine-var} % missing problems
\include{tex/alg-geom/zariski} % missing problems
\include{tex/alg-geom/def-sheaf}  % 
\include{tex/alg-geom/def-scheme}  % TODO
\include{tex/alg-geom/proj-var} % TODO

\part{Algebraic Geometry II: Applications of Schemes}
