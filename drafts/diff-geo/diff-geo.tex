...
\emph{NB: this chapter is isolated in the dependency graph and can be safely skipped.}
...
\begin{definition}
	We define a \vocab{$k$-form} $\alpha$ to be a smooth (infinitely differentiable)
