...
This is what makes differential forms good for integrating, which we'll do in the next chapter.
For now, let's differentiate them:
...
to a $k$-form on $U$.
In particular, if $U = [a,b]$, we can resort to our old definition of an integral.\footnote{
...
\begin{example}
	...
	Let $V = \RR^2$, and suppose $\phi : V \to V'$ is given by sending
