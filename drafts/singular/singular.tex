...
one in this section and the other in \Cref{sec:excision}.
...
\begin{proof}
	...
	In particular, consider the two generators $z_1$ and $z_2$ of $\wt H_1(U \cap V) = \ZZ^{\oplus 2}$,
	i.e.\ one cycle in each connected component of $U \cap V$.
	Moreover, let $\alpha_U$ denote the generator of $\wt H_1(U) \cong \ZZ$,
	and $\alpha_V$ the generator of $H_2(U) \cong \ZZ$.
	Then we have that
	...
	In fact, from this it is not hard to see that
	\[ \ker\phi = \left< z_1 - z_2 \right> \cong \ZZ. \]
